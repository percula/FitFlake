...
public class DigitalWatchFaceCompanionConfigActivity extends Activity
    ...
    private void setUpAllPickers(DataMap config) {
        ...
        setUpColorPickerSelection(R.id.hours, KEY_HOURS_COLOR, config, ContextCompat.getColor(this,R.color.md_white));
        setUpColorPickerSelection(R.id.minutes, KEY_MINUTES_COLOR, config, ContextCompat.getColor(this,R.color.md_white));
        setUpColorPickerSelection(R.id.seconds, KEY_SECONDS_COLOR, config, ContextCompat.getColor(this,R.color.md_grey_500));
...
//        int defaultColor = Color.parseColor(defaultColorName);
        ...
        String[] colorNames = getResources().getStringArray(R.array.md_color_array);
